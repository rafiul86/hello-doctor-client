...
const Testimonial = () => {
  const opinions = [
    {
      description:
        "Lorem ipsum dolor, sit amet consectetur adipisicing elit. At cumque aspernatur ducimus alias, vero dolorem.",
      name: "John",
      location: "Ohio",
      id: "1",
      img: john,
    ...
    <section className="offset-md-2 align-items-center justify-content-center mt-5">
      ...
      <Grid className=" offset-md-2 ms-5 mt-5" container spacing={8}>
        {opinions.map((opinion) => (
          <Grid item>
            <TestimonialDetails opinion={opinion}></TestimonialDetails>
          </Grid>
        ))}
      </Grid>
    </section>
